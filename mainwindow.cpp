...
void MainWindow::initVariables()
{
    ...
    //this dialog has to be initialized because we use it
    //to check if voice is installed before speaking
...
//        installVoicesDialog->isSelectedVoiceInstalled(engineVoice);
    checkInstalledVoice();
